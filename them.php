...
<div class="container"> 
	 	<div class="row"> 
	 	 	<div class="col-md-12"> 
	 	 	 	...
	 	 	 	<form role="form" method="post"  enctype= multipart/form-data action="thuchienthem.php">  
	 	 	 	  <div class="form-group"> 
	 	 	 	 	<label for="exampleInputEmail1">Mã Hàng</label> 
 	 	 	 	<input type="text" class="form-control" id="MaHang" name="MaHang" placeholder="Nhập mã Hàng"> 
	 	 	 	  </div> 
	 	 	 	  <div class="form-group"> 
	 	 	 	 	<label for="exampleInputPassword1">Tên Hàng</label> 
 	 	 	 	<input type="text" class="form-control" id="TenHang" name="TenHang" placeholder="Nhập Tên Hàng"> 
	 	 	 	  </div> 	
	 	 	 	  <div class="form-group"> 
	 	 	 	 	<label for="exampleInputPassword1">Hình</label> 
 	 	 	 	<input type="file" class="form-control" id="Hinh" name="Hinh" placeholder="Nhập Hình"> 
	 	 	 	  </div> 
				<div class="form-group"> 
				<label for="exampleInputPassword1">Giá Cũ</label> 
				<input type="text" class="form-control" id="GiaCu" name="GiaCu" placeholder="Nhập Giá Cũ"> 
				</div> 
				<div class="form-group"> 
				<label for="exampleInputPassword1">Giá Mới</label> 
				<input type="text" class="form-control" id="GiaMoi" name="GiaMoi" placeholder="Nhập Giá Mới"> 
				</div> 
